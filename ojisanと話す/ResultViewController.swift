...
class ResultViewController: UIViewController {
    ...
    let voices: [[String]] = [["きみの仕事ぶりはうわさに聞いているよ", "ボーナス？ふふふ……", "秘書の山田くんを呼んでくれないか？いや座布団が欲しいわけじゃない。", "仕事が進んでいるようで何よりだ","たまにはゆっくり休むことも大事だ","きみはたけのこ派かね？ふーん、きのこが好きっと…ははは"], ["へい、いらっしゃい！", "何から行きます？", "申し訳ねぇが、今日は赤味噌切らしてんだ旦那", "酒は飲んでも呑まれるなってね、まぁ旦那には今更か","今日はハマチの活きがいいよ！","へい鱧の天ぷらおまちどう！","実は寿司という字が充てられたのは江戸時代からって知ってたかい？"], ["余、暗殺されかけすぎて絶対暗殺で死ぬと思ってたもん", "人質の時のこと？ほう、面白いことを聞くじゃあないか", "力こそパワーじゃ", "実は万里の長城は余が作り始めたわけじゃない。","水銀の味？どうだったかなぁ"], ["最近の油田？絶好調デス", "王族は堅苦しいデスからね", "年収？さぁ…最近数えてませんネ", "تزوجيني"]]
